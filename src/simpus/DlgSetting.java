...
public class DlgSetting extends JDialog
{
    ...
    public DlgSetting(final Frame parent, final boolean modal) {
        super(parent, modal);
        ...
        this.setSize(458, 264);
        final Object[] row = { "<html><font color='#006699' face='Comic Sans MS'>Nama Instansi</font></html>", "<html><font color='#006699' face='Comic Sans MS'>Alamat Instansi</font></html>" };
        ...
        this.TKd.setDocument((Document)new batasInput(120).getKata((JTextField)this.TKd));
        this.TNm.setDocument((Document)new batasInput(120).getKata((JTextField)this.TNm));
    }
    ...
    private void initComponents() {
        ...
        this.panelGlass1.setPreferredSize(new Dimension(100, 79));
        ...
        this.TKd.addKeyListener((KeyListener)new KeyAdapter() {
            public void keyPressed(final KeyEvent evt) {
                DlgSetting.this.TKdKeyPressed(evt);
            }
        });
        this.panelGlass1.add((Component)this.TKd);
        this.TKd.setBounds(98, 12, 342, 23);
        ...
        this.TNm.addKeyListener((KeyListener)new KeyAdapter() {
            public void keyPressed(final KeyEvent evt) {
                DlgSetting.this.TNmKeyPressed(evt);
            }
        });
        this.panelGlass1.add((Component)this.TNm);
        this.TNm.setBounds(98, 42, 342, 23);
        this.label2.setText("Alamat Perpus :");
        this.label2.setName("label2");
        this.panelGlass1.add((Component)this.label2);
        this.label2.setBounds(18, 42, 110, 23);
        this.label4.setText("Nama Perpus :");
        this.label4.setName("label4");
        this.panelGlass1.add((Component)this.label4);
        this.label4.setBounds(24, 12, 90, 23);
        ...
        this.BtnSimpan.addActionListener((ActionListener)new ActionListener() {
            public void actionPerformed(final ActionEvent evt) {
                DlgSetting.this.BtnSimpanActionPerformed(evt);
            }
        });
        this.BtnSimpan.addKeyListener((KeyListener)new KeyAdapter() {
            public void keyPressed(final KeyEvent evt) {
                DlgSetting.this.BtnSimpanKeyPressed(evt);
            }
        });
        ...
        this.BtnBatal.addActionListener((ActionListener)new ActionListener() {
            public void actionPerformed(final ActionEvent evt) {
                DlgSetting.this.BtnBatalActionPerformed(evt);
            }
        });
        this.BtnBatal.addKeyListener((KeyListener)new KeyAdapter() {
            public void keyPressed(final KeyEvent evt) {
                DlgSetting.this.BtnBatalKeyPressed(evt);
            }
        });
        ...
        this.BtnHapus.addActionListener((ActionListener)new ActionListener() {
            public void actionPerformed(final ActionEvent evt) {
                DlgSetting.this.BtnHapusActionPerformed(evt);
            }
        });
        this.BtnHapus.addKeyListener((KeyListener)new KeyAdapter() {
            public void keyPressed(final KeyEvent evt) {
                DlgSetting.this.BtnHapusKeyPressed(evt);
            }
        });
        ...
        this.BtnEdit.addActionListener((ActionListener)new ActionListener() {
            public void actionPerformed(final ActionEvent evt) {
                DlgSetting.this.BtnEditActionPerformed(evt);
            }
        });
        this.BtnEdit.addKeyListener((KeyListener)new KeyAdapter() {
            public void keyPressed(final KeyEvent evt) {
                DlgSetting.this.BtnEditKeyPressed(evt);
            }
        });
        ...
        this.BtnKeluar.addActionListener((ActionListener)new ActionListener() {
            public void actionPerformed(final ActionEvent evt) {
                DlgSetting.this.BtnKeluarActionPerformed(evt);
            }
        });
        this.BtnKeluar.addKeyListener((KeyListener)new KeyAdapter() {
            public void keyPressed(final KeyEvent evt) {
                DlgSetting.this.BtnKeluarKeyPressed(evt);
            }
        });
        ...
        this.tbSetPinjam.addMouseListener(new MouseAdapter() {
            public void mouseClicked(final MouseEvent evt) {
                DlgSetting.this.tbSetPinjamMouseClicked(evt);
            }
        });
        this.tbSetPinjam.addKeyListener(new KeyAdapter() {
            public void keyPressed(final KeyEvent evt) {
                DlgSetting.this.tbSetPinjamKeyPressed(evt);
            }
        });
        ...
        this.jLabel1.setText(":: SETUP APLIKASI ::");
    ...
    private void BtnSimpanActionPerformed(final ActionEvent evt) {
        if (this.TKd.getText().trim().equals("")) {
            this.Valid.textKosong((JTextField)this.TKd, "Nama Instansi");
        }
        else if (this.TNm.getText().trim().equals("")) {
            this.Valid.textKosong((JTextField)this.TNm, "Alamat Instansi");
        }
        else if (this.tabMode.getRowCount() == 0) {
            this.Sequel.menyimpan("setting", "'" + this.TKd.getText() + "','" + this.TNm.getText() + "','','','',''", "Nama Instansi");
            this.tampil();
            this.emptTeks();
        }
        else if (this.tabMode.getRowCount() > 0) {
            JOptionPane.showMessageDialog(null, "Maaf, Hanya diijinkan satu Instansi ...!!!!");
    ...
    private void BtnHapusActionPerformed(final ActionEvent evt) {
        if (this.tabMode.getRowCount() == 0) {
            ...
            this.Sequel.queryu("delete from setting");
            this.tampil();
            this.emptTeks();
        }
    }
    ...
    private void BtnEditActionPerformed(final ActionEvent evt) {
        if (this.TKd.getText().trim().equals("")) {
            ...
            this.Sequel.queryu("update setting set alamat_instansi='" + this.TNm.getText() + "'," + "nama_instansi='" + this.TKd.getText() + "'");
            if (this.tabMode.getRowCount() != 0) {
                this.tampil();
            }
            this.emptTeks();
    ...
    private void BtnKeluarActionPerformed(final ActionEvent evt) {
        if (this.tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, data setting aplikasi tidak boleh kosong ...!!!!");
            this.TKd.requestFocus();
        }
        else if (this.tabMode.getRowCount() != 0) {
            this.dispose();
    ...
    public static void main(final String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                final DlgSetting dialog = new DlgSetting(new JFrame(), true);
    ...
    public void tampil() {
        final String sql = "select nama_instansi,alamat_instansi from setting";
        this.prosesCari(sql);
    }
